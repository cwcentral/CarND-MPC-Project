...
// See CarND-MPC-Quizzes MPC.cpp

// init a vector of initial values with spacing of N
size_t x_start = 0;
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
	...
	// we deal with latency by providing a solution that includes the next time step
	// hence dt MUST BE 0.1 for 100ms latency!
